@if (auth()->user()->hasAnyPermission(['department.edit', 'department.destroy']))
    <a href="No" class="btn btn-flex btn-sm btn-light btn-center btn-active-light-primary ps-5 pe-3"
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-3"
        ...
        @can('department.edit')
            <div class="menu-item px-3">
                <a href="{{ route('departments.edit', $query->id) }}" class="menu-link px-3">
