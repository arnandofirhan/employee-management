<?php
$title = __('Create :name', ['name' => __('Department')]);
$breadcrumbs = [
    [
        'name' => __('Departments'),
    ...
    [
        'name' => __('Create :name', ['name' => __('Department')]),
        'url' => null,
    ],
];
?>
        ...
        <div class="card mb-8 mb-xl-10">
            <div class="card-header border-0">
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">{{ __('Create :name', ['name' => __('Department')]) }}</h3>
                </div>
            </div>

            <form id="form" onsubmit="return false" novalidate="novalidate" class="form"
                data-url-action="{{ route('departments.store') }}">
                        ...
                        <div class="col-sm-12 mb-10 fv-row">
                            ...
                            <div class="form-check form-switch form-check-custom form-check-success form-check-solid">
                                ...
                                <label class="form-check-label cursor-pointer" for="is_active">
                                    {{ __('Is Active :name', ['name' => strtolower(__('Department'))]) }}
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{ route('departments.index') }}" class="btn btn-light btn-active-light-secondary me-2">
                        {{ __('Back') }}
                    </a>
