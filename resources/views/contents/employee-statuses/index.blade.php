...
<x-main-app-layout :title="$title" :breadcrumbs="$breadcrumbs">
                ...
                @can('employee-status.create')
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end">
                            <a class="btn btn-primary" href="{{ route('employee-statuses.create') }}">
    ...
    <x-slot name="script">
        <script>
            var indexUrl = `{{ route('employee-statuses.index') }}`;
            var tableId = `table_employee_status`;
        </script>
